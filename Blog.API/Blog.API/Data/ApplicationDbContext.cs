...
namespace Blog.API.Data
{
    ...
    {
        public ApplicationDbContext(DbContextOptions options) : base(options) //Passes the confugaration options that defines the how the database context should be configured
        {
        }
